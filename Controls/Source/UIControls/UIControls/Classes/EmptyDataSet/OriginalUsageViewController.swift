...
struct Configuration {
    ...
    init(_ app: String, controller: UITableViewController) {
        self.app = app
    ...
    var image: UIImage? {
        if isLoading {
            ...
            let imageNamed = ("placeholder_" + app).lowercased().replacingOccurrences(of: " ", with: "_")
    ...
    func buttonBackgroundImage(_ state: UIControlState) -> UIImage? {
        var imageName = "button_background_\(app)".lowercased()
