...
class RangeSelectionVc: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        calendarView.register(UINib(nibName: "TestRangeSelectionViewControllerCell", bundle: nil), forCellWithReuseIdentifier: "TestRangeSelectionViewControllerCell")
...
extension RangeSelectionVc: JTAppleCalendarViewDelegate, JTAppleCalendarViewDataSource {
    ...
    func calendar(_ calendar: JTAppleCalendarView, cellForItemAt date: Date, cellState: CellState, indexPath: IndexPath) -> JTAppleCell {
        let cell = calendar.dequeueReusableJTAppleCell(withReuseIdentifier: "TestRangeSelectionViewControllerCell", for: indexPath) as! TestRangeSelectionViewControllerCell
