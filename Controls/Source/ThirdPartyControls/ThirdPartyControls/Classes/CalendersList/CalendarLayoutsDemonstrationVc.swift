...
//
//  Created by sairam on 2018-08-29.
//
//

import JTAppleCalendar

class CalendarLayoutsDemonstrationVc: UIViewController {
...
extension CalendarLayoutsDemonstrationVc: JTAppleCalendarViewDelegate, JTAppleCalendarViewDataSource {
